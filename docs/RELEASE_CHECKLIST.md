...
Use this checklist before publishing WisDev Research Runtime as a standalone
...
- DocGen offline smoke: `wisdev docgen --offline --intent report -q "test topic"` (should emit a scaffold Quick Report).
