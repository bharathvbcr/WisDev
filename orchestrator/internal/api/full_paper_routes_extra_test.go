...
func TestFullPaperActionHelpers(t *testing.T) {
	...
	t.Run("applyFullPaperControlAction", func(t *testing.T) {
		pauseJob := newJob()
		applyFullPaperControlAction(pauseJob, "pause")
		...
		resumeJob := newJob()
		applyFullPaperControlAction(resumeJob, "resume")
		assert.Equal(t, "running", resumeJob["status"])

		retryJob := newJob()
		applyFullPaperControlAction(retryJob, "retry_stage")
		...
		cancelJob := newJob()
		applyFullPaperControlAction(cancelJob, "cancel")
