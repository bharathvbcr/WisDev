...
func unifiedResearchMetadataParityLoopResult() *wisdev.LoopResult {
	...
	return &wisdev.LoopResult{
		...
		DraftCritique: &wisdev.LoopDraftCritique{
			...
			Reasoning:               "Post-retrieval review found the synthesis improved after follow-up retrieval.",
			Confidence:              0.81,
		},
		ReasoningTrace: []wisdev.ReasoningTraceEntry{
			{
				...
				Reasoning: "The revised answer should expose its review trail across every runtime surface.",
			},
		},
