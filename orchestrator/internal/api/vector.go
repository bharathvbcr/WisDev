...
// BatchSimilarityRequest is the request body for POST /vector/batch-similarity.
type BatchSimilarityRequest struct {
	QueryEmbedding []float64        `json:"query_embedding"`
	Papers         []PaperEmbedding `json:"papers"`
}

// BatchSimilarityResponse is the response for POST /vector/batch-similarity.
...
// FuseRequest is the request body for POST /vector/fuse.
...
// FuseResponse is the response for POST /vector/fuse.
...
// handleBatchSimilarity handles POST /vector/batch-similarity.
//
// Request:
//
//	{
...
// handleFuseResults handles POST /vector/fuse.
//
// Request:
//
//	{
