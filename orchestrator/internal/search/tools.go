...
var (
	SearchPapersToolAliases = []string{"search_papers", "retrieve_papers", "research.retrievePapers", "wisdev.retrievePapers", "wisdevSearchPapers", "scholarlmSearchPapers", "scholarlm.retrievePapers"}
...
func HandleToolSearch(ctx context.Context, reg *ProviderRegistry, tool string, params map[string]any) (SearchResult, error) {
	...
	case ToolSearchPapersName:
		...
		opts := SearchOpts{
			...
			TraceID:     stringParam(params, "traceId"),
		}
