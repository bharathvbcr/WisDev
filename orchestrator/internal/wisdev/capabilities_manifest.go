...
func BuildDeepAgentsCapabilities(registry *ToolRegistry) DeepAgentsCapabilities {
	...
	candidateActions := []string{
		...
		ActionResearchDetectContradictions,
...
func ResolveDeepAgentsExecutionPolicy(
	...
	if resolvedMode == "yolo" {
		// YOLO is the canonical autonomous no-HITL mode. Do not let a stale
		// browser fallback policy reintroduce guided confirmation gates.
		requireHumanConfirmation = false
	}
