	...
	return []Question{
		{
			...
			IsMultiSelect: true,
			IsRequired:    true,
			HelpText:      "Choose every domain that should shape retrieval vocabulary, source ranking, and evidence expectations.",
			Options: []QuestionOption{
				{Value: "medicine", Label: "Medicine & Healthcare", Description: "Clinical, translational, patient, and public-health evidence"},
				{Value: "cs", Label: "Computer Science & AI", Description: "Algorithms, systems, benchmarks, datasets, and model evaluation"},
				{Value: "social", Label: "Social Sciences", Description: "Behavioral, policy, economics, education, and population studies"},
				{Value: "climate", Label: "Climate & Environment", Description: "Climate science, ecology, sustainability, and earth systems"},
				{Value: "neuro", Label: "Neuroscience", Description: "Brain, cognition, behavior, imaging, and neural mechanisms"},
				{Value: "physics", Label: "Physics & Engineering", Description: "Physical systems, experiments, simulations, and applied engineering"},
				{Value: "biology", Label: "Biology & Life Sciences", Description: "Molecular, cellular, organismal, genetics, and omics evidence"},
				{Value: "humanities", Label: "Humanities", Description: "Historical, interpretive, cultural, and textual scholarship"},
			},
		},
		{
			ID:            "q2_scope",
			...
			IsMultiSelect: false,
			IsRequired:    true,
			HelpText:      "This controls how many topic branches and parallel query tabs WisDev will prepare.",
			Options: []QuestionOption{
		...
		},
		{
			...
			IsMultiSelect: false,
			IsRequired:    true,
			HelpText:      "WisDev keeps foundational work when useful, but this tells the planner what recency bias to apply.",
			Options: []QuestionOption{
		...
		},
		{
			...
			IsMultiSelect: true,
			IsRequired:    true,
			HelpText:      "These become topic-tree branches, so choose the angles users must see in the final search.",
		},
		{
			ID:            "q5_study_types",
			Type:          TypeStudyTypes,
			...
			IsMultiSelect: true,
			IsRequired:    true,
			HelpText:      "WisDev uses these as query modifiers so each tab can favor the right kind of evidence.",
		},
		{
			ID:            "q6_exclusions",
			Type:          TypeExclusions,
			...
			IsMultiSelect: true,
			IsRequired:    true,
			HelpText:      "Pick constraints that should be filtered from generated queries and later evidence ranking.",
			Options: []QuestionOption{
				{Value: "none", Label: "No exclusions", Description: "Keep all source classes unless later evidence checks reject them"},
				{Value: "preprints", Label: "Exclude preprints", Description: "Prefer formally published or accepted work"},
				{Value: "non_english", Label: "Exclude non-English studies", Description: "Limit retrieval to English-language records"},
				{Value: "low_sample_size", Label: "Exclude small or underpowered studies", Description: "Down-rank weak empirical power when sample size matters"},
				{Value: "non_peer_reviewed", Label: "Exclude non-peer-reviewed sources", Description: "Prioritize peer-reviewed venues and indexed literature"},
				{Value: "animal_studies", Label: "Exclude animal studies", Description: "Prefer human or directly applicable evidence"},
			},
		},
		{
			...
			IsMultiSelect: true,
			IsRequired:    true,
			HelpText:      "These quality signals are threaded into the query plan and evidence-gate expectations.",
			Options: []QuestionOption{
				{Value: "peer_reviewed", Label: "Peer-reviewed only", Description: "Prefer sources with formal editorial and reviewer scrutiny"},
				{Value: "high_citation_signal", Label: "High citation signal", Description: "Prefer work with visible scholarly uptake"},
				{Value: "recent_replication", Label: "Replication or validation evidence", Description: "Look for confirmatory or external validation studies"},
				{Value: "methods_transparency", Label: "Transparent methods and data", Description: "Favor reproducible methods, code, data, or protocol detail"},
			},
		},
		{
			ID:            "q8_output_focus",
			...
			IsMultiSelect: false,
			IsRequired:    true,
			HelpText:      "This steers the final synthesis toward ranking, coverage, limitations, or method comparison.",
			Options: []QuestionOption{
				{Value: "best_papers", Label: "Best papers first", Description: "Rank the strongest sources before broad mapping"},
				{Value: "coverage_map", Label: "Broad coverage map", Description: "Show how the field is organized across subtopics"},
				{Value: "evidence_gaps", Label: "Evidence gaps and limitations", Description: "Surface uncertainty, missing studies, and weak claims"},
				{Value: "method_comparison", Label: "Method comparison", Description: "Compare methods, datasets, designs, or evaluation protocols"},
			},
		},
	}
}
