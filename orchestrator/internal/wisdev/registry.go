...
func (r *ToolRegistry) registerDefaults() {
	...
	r.Register(ToolDefinition{
		Name:               ActionResearchResolveCanonicalCitations,
		Description:        "Resolve retrieved papers against canonical citation authorities and return normalized citation records.",
		Risk:               RiskLevelMedium,
		ModelTier:          ModelTierStandard,
		ExecutionTarget:    ExecutionTargetGoNative,
		Parallelizable:     false,
		EstimatedCostCents: 2,
		ParameterSchema:    json.RawMessage(`{"type":"object","properties":{"papers":{"type":"array","items":{"type":"object","additionalProperties":true}},"citations":{"type":"array","items":{"type":"object","additionalProperties":true}},"canonicalSources":{"type":"array","items":{"type":"object","additionalProperties":true}}}}`),
	})
	r.Register(ToolDefinition{
	...
	r.Register(ToolDefinition{
		Name:               ActionResearchDetectContradictions,
		Description:        "Detect contradictions and cross-source conflicts in retrieved evidence before synthesis.",
		Risk:               RiskLevelMedium,
		ModelTier:          ModelTierStandard,
		ExecutionTarget:    ExecutionTargetPythonCapability,
		Parallelizable:     false,
		EstimatedCostCents: 3,
		ParameterSchema:    json.RawMessage(`{"type":"object","properties":{"papers":{"type":"array","items":{"type":"object","additionalProperties":true}}}}`),
	})
	r.Register(ToolDefinition{
	...
	r.Register(ToolDefinition{
		Name:               ActionResearchVerifyReasoningPaths,
		Description:        "Verify autonomous reasoning branches against provenance before final synthesis.",
		Risk:               RiskLevelHigh,
		ModelTier:          ModelTierHeavy,
		ExecutionTarget:    ExecutionTargetGoNative,
		Parallelizable:     false,
		EstimatedCostCents: 3,
		ParameterSchema:    json.RawMessage(`{"type":"object","properties":{"branches":{"type":"array","items":{"type":"object","additionalProperties":true}}}}`),
	})
	r.Register(ToolDefinition{
