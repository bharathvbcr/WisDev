...
def _emit_artifacts(action: str, raw_result: dict[str, Any]) -> dict[str, Any]:
    envelope = emit_for_action(action, raw_result)
    return flatten_to_artifact_map(envelope)
