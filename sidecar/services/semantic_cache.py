...
from services.model_config import get_embedding_model
...
class SemanticCache:
    ...
    def __init__(
        ...
        self.embedding_model = embedding_model or get_embedding_model("standard")
        embedding_dimension = os.environ.get("EMBEDDING_OUTPUT_DIMENSION", "768")
        self.embedding_version = (
            os.environ.get("EMBEDDING_SPACE_VERSION")
            or f"{self.embedding_model}-{embedding_dimension}-v1"
        )
