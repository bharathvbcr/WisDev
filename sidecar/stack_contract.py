"""WisDev Research Runtime stack contract.

The open-source stack is Go-first with an optional Python ML sidecar. It does
not include the private parent-app edge service.
"""

ENDPOINTS_MANIFEST = {
    "version": 4,
    "environment": "open-source",
    "canonicalRequestFlow": [
        "go_orchestrator",
        "python_sidecar",
    ],
    "ports": {
    ...
    "dependencies": [
        {
            "from": "go_orchestrator",
            "to": "python_sidecar",
            "transport": "grpc-protobuf",
            "description": "Go uses gRPC for optional local/container LLM sidecar RPCs.",
        },
        {
            "from": "go_orchestrator",
            "to": "python_sidecar",
            "transport": "http-json",
            "description": "Go uses HTTP for optional ML primitives and remote LLM RPCs.",
        },
    ],
    "httpRoutes": {
        "go_orchestrator": [
    ...
    "grpcTargets": {
        "python_sidecar": {
            "envVar": "PYTHON_SIDECAR_GRPC_ADDR",
            "transport": "grpc-protobuf",
            "source": "go_orchestrator",
            "target": "python_sidecar",
            "defaultAddress": "127.0.0.1:50052",
        },
        "go_internal": {
            "envVar": "GO_INTERNAL_GRPC_ADDR",
            "transport": "grpc-protobuf",
            "source": "go_orchestrator",
            "target": "go_orchestrator",
    ...
    "protoContracts": {
        "llm": {
            "source": "orchestrator/proto/llm/llm.proto",
            "generatedGo": [
                "orchestrator/proto/llm/llm.pb.go",
                "orchestrator/proto/llm/llm_grpc.pb.go",
            ],
            "generatedPython": [
                "sidecar/proto/llm_pb2.py",
                "sidecar/proto/llm_pb2_grpc.py",
            ],
            "requiredMethods": [
                "Generate",
                "GenerateStream",
...
ENDPOINTS_MANIFEST_VERSION = ENDPOINTS_MANIFEST["version"]
ENDPOINTS_DEFAULT_OVERLAY = "local"
